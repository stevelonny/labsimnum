...
int main (int argc, char *argv[]){
    ...
    array<int, 3> b_count = {0, 0, 0}; //thread monitoring
    ...
    array<double, 3> temp = {0.8, 1.1, 1.2}; //starting temps should not matter when velocities.in is present or when using verlet (?)
